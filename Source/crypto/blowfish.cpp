...
{
	memcpy(p, p_static, sizeof(unsigned int) * 268);
	memcpy(s0, s0_static, sizeof(unsigned int) * 256);
	memcpy(s1, s1_static, sizeof(unsigned int) * 256);
	memcpy(s2, s2_static, sizeof(unsigned int) * 256);
	memcpy(s3, s3_static, sizeof(unsigned int) * 256);
...
unsigned int BLOWFISH::s0_static[] = {
...
unsigned int BLOWFISH::s1_static[] = {
...
unsigned int BLOWFISH::s2_static[] = {
...
unsigned int BLOWFISH::s3_static[] = {
...
unsigned int BLOWFISH::p_static[] = {
